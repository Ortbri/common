        ...
        <div className="mx-auto flex items-center justify-between px-4 py-4 lg:p-6">
          ...
          >
            ...
            <motion.button
              ...
              className="light:bg-white border-neutral flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border-[1px] bg-white px-2 dark:bg-black"
              whileHover={{
                scale: 1.1,
              }}
              whileTap={{ scale: 0.95 }}
            ...
            <nav className="flex h-full flex-col items-center justify-center">
              <ul className="space-y-8 text-center">
                {menuItems.map((item, i) => (
                  <motion.li key={item.name} custom={i} variants={menuItemVariants}>
                    <motion.a
                      href={item.href}
